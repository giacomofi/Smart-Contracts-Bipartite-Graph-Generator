...
if __name__ == '__main__':
    ...
    print("Type the path of the DApp here:")
    directory = input()
    print("Where do you want to store your csv? (type path here):")
    result_path = input()
    for root, dirs, files in os.walk(directory):
        for file in files:
            if file.endswith('.sol'):
                ...
                with open(contract_path, "r") as sol_file:
                    # print(contract_path)
                ...
                listener.write_csv(file, result_path)
                # Writing on CSV file
